export const FeatureCards = () => (
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 mt-0 max-h-full sm:max-h-[300px] overflow-y-auto sm:overflow-hidden">
    {[
      {
      ...
      <div key={index} className="bg-white p-3 md:p-4 shadow-md rounded-lg border border-gray-200">
